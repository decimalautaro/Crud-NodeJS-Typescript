...
export class nuevoCampoPrestacionSercio1669349125520 implements MigrationInterface {
    name = 'nuevoCampoPrestacionSercio1669349125520'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_prestacionServicio" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "tecnicoId" varchar NOT NULL, "servicioId" varchar NOT NULL, "insumoId" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "tipoPrestacion" varchar NOT NULL, CONSTRAINT "FK_9b3df4683625097a4dc55a32a48" FOREIGN KEY ("insumoId") REFERENCES "insumos" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_3c5ba1eee5e8a371b2630a6738f" FOREIGN KEY ("servicioId") REFERENCES "servicios" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_c7685731e63b58a1aa256b89e8b" FOREIGN KEY ("tecnicoId") REFERENCES "tecnicos" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1ee88aa5f50879cf006651011bc" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "prestacionServicio" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "tecnicoId" varchar NOT NULL, "servicioId" varchar NOT NULL, "insumoId" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_9b3df4683625097a4dc55a32a48" FOREIGN KEY ("insumoId") REFERENCES "insumos" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_3c5ba1eee5e8a371b2630a6738f" FOREIGN KEY ("servicioId") REFERENCES "servicios" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_c7685731e63b58a1aa256b89e8b" FOREIGN KEY ("tecnicoId") REFERENCES "tecnicos" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1ee88aa5f50879cf006651011bc" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
